...
var password = "123qwe";
    ...
    var valueSkill = $('#ParentSkillValue').val();
    var valueSkillChild = $("input[name='ChildSkillValue']")
        .map(function () { return $(this).val(); }).get();
    console.log(valueSkillChild);
var auth = {
...
function GetSkillParent(token) {
    ...
    $.ajax({
        ...
        success: function (responseData, textStatus, jqXHR) {
            ...
            $('#keahlian1').val(valueSkill);
            GetChildSkill(valueSkill);
            //Tester(responseData.result.accessToken);
        },
        error: function (responseData, textStatus, errorThrown) {
            //urls = "/Home/Error";
    ...
    function GetChildSkill(parentId) {
        $.ajax({
            type: "GET",
            url: get_url + "/api/services/app/ApiSkill/GetChildByParentId?id=" + parentId + "",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
